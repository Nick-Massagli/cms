...
export class MessageService {
  ...
  getMessages() {
    //use http get
    this.http.get('https://nmasscms-default-rtdb.firebaseio.com/messages.json')
  ...
  storeMessages() {
    ...
    this.http.put('https://nmasscms-default-rtdb.firebaseio.com/messages.json', messages, { headers: headers })
